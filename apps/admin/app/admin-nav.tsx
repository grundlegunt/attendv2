...
const links = [["/scheduling", "Scheduling"], ["/film-series", "Film Series"], ["/cinema-setup", "Cinema Setup"], ["/menu", "Menu"], ["/branding", "Brand Status"], ["/reports", "Reports & Finance"], ["/labor", "Labor"], ["/location", "Location"], ["/promotions", "Promotions"], ["/taxes", "Tax & Service Charges"], ["/users", "Users & Permissions"], ["/refunds", "Refunds"], ["/audit-log", "Audit Log"]] as const;
