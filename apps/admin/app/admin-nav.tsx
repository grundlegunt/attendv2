...
const links = [["/scheduling", "Scheduling"], ["/cinema-setup", "Cinema Setup"], ["/menu", "Menu"], ["/reports", "Reports & Finance"], ["/labor", "Labor"], ["/location", "Location"], ["/branding", "Branding"], ["/promotions", "Promotions"], ["/taxes", "Tax & Service Charges"], ["/users", "Users & Permissions"], ["/refunds", "Refunds"], ["/audit-log", "Audit Log"]] as const;
