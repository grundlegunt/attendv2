...
type Plan = { id: string; name: string; description: string | null; priceCents: number; durationMonths: number; benefits: unknown; autoRenew: boolean; active: boolean; _count: { memberships: number }; activeMemberCount: number; paidPurchaseCount: number; paidRevenueCents: number };
