...
export default function GlobalError({ error, reset }: { error: Error & { digest?: string }; reset: () => void }) {
  ...
  return <html><body><main style={{ maxWidth: 720, margin: "15vh auto", padding: 32, fontFamily: "system-ui" }}><h1>Attend Master encountered an error</h1><p>A private error reference was recorded without client, payment, or login details.</p><button onClick={reset}>Try again</button></main></body></html>;
}
