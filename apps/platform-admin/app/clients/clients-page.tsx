            ...
            <>
              ...
              <section className="dashboard-panel commercial-terms-panel">
                ...
                {organization.ticketFeeSettlement && <div className="agreement-settlement">
                  ...
                  <div><small>Agreement expected fees</small><strong>{money(organization.ticketFeeSettlement.platformShareCents + organization.ticketFeeSettlement.operatorShareCents)}</strong><em>{feeVarianceLabel(organization.ticketFeeSettlement.varianceCents)}</em></div>
