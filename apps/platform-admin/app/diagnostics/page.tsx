...
export default function DiagnosticsPage() {
  ...
  return <main className="shell">
    <header><div><p className="eyebrow platform-master-label" /><h1>Request diagnostics</h1><p className="muted">Recent API latency from this browser session. Browser wait minus API time highlights network, cold-start, and response-transfer overhead.</p></div><button className="quiet" onClick={() => clearPlatformRequestTimings()}>Clear session data</button></header>
