...
type Counts = Record<"Pageview" | "Checkout Started" | "Checkout Completed" | "Account Created" | "Gift Card Started" | "Gift Card Purchased" | "Membership Checkout Started" | "Membership Activated" | "Donation Checkout Started" | "Donation Completed" | "Private Event Inquiry Submitted" | "Waitlist Joined", number>;
type Rates = { checkoutCompletionRatePercent: number | null; giftCardCompletionRatePercent: number | null; membershipCompletionRatePercent: number | null; donationCompletionRatePercent: number | null };
type Report = {
  generatedAt: string;
