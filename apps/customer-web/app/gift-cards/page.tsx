...
export default function GiftCardsPage() {
  ...
  useEffect(() => { apiFetch<Config>("/gift-card-purchases/config").then(setConfig).catch(() => setError("Gift card purchasing is temporarily unavailable.")); }, []);
