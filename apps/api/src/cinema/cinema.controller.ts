...
export class CinemaController {
  ...
  @Get("admin/dashboard-bootstrap")
  @UseGuards(JwtAuthGuard, PermissionsGuard)
  @RequirePermissions(Permission.AuditoriumManage, Permission.MovieManage, Permission.ShowtimeManage)
  adminDashboardBootstrap(@CurrentActor() actor: RequestActor) {
  ...
  adminSeatAvailability(@CurrentActor() actor: RequestActor, @Param("id") id: string) {
    return this.cinemaService.adminSeatAvailability(actor, id);
  }
  ...
  permanentlyDeleteMovie(
    ...
    return this.cinemaService.permanentlyDeleteMovie(actor, id, requestId);
  }
