...
describe("isCorsOriginAllowed", () => {
  ...
  it("allows only this project's Vercel admin preview aliases", () => {
    expect(
      isCorsOriginAllowed(
    ...
    expect(isCorsOriginAllowed("https://attendv2-git-feature-attend3.vercel.app", configuredOrigins)).toBe(false);
