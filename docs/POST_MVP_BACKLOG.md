...
- **Expanded CRM relationships and engagement** — the admin search now opens a location-scoped customer record with ticket and dining history, films, seats, purchased items, account type, and completed spend. Donations, memberships, communications, household/family links, and custom fields still require their own product models.
